...
const router = createBrowserRouter([
  ...
  { element: <ProtectedRoute role="owner" />, children: [{ path: '/app', element: <OwnerShell />, children: [{ element: <OwnerGate />, children: [{ index: true, element: <DashboardPage /> }, { path: 'products', element: <ProductsPage /> }, { path: 'inventory', element: <Navigate to="/app/products" replace /> }, { path: 'shopkeepers', element: <ShopkeepersPage /> }, { path: 'sales', element: <SalesPage /> }, { path: 'sales/:saleId', element: <SaleDetailPage /> }, { path: 'payments', element: <PaymentsPage /> }, { path: 'reports', element: <ReportsPage /> }, { path: 'settings', element: <SettingsPage /> }, { path: 'profile', element: <ProfilePage /> }] }] }] },
