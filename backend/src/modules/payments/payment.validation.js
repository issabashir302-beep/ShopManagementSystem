import { positiveInteger, rejectUnknownFields, requireObject, uuidField } from '../../utils/validation.js'
...
export function validatePaymentList(query) {
  ...
  return { page: positiveInteger(query.page, 'page', { defaultValue: 1, max: 1_000_000 }),
